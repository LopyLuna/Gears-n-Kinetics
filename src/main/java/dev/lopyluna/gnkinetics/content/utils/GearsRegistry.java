...
public record GearsRegistry(String modID) {
    ...
    public void register(IEventBus bus) {
        System.out.println("Registering " + Gears.FULL_NAME + " Data Components...");
        DATA_COMPONENTS.register(bus);
        System.out.println("Registering " + Gears.FULL_NAME + " Creative Tabs...");
        CREATIVE_MODE_TABS.register(bus);
        System.out.println("Registering " + Gears.FULL_NAME + " Damage Types...");
        DAMAGES.register(bus);
        System.out.println("Registering " + Gears.FULL_NAME + " Mob Effects...");
        MOB_EFFECTS.register(bus);
        System.out.println("Registering " + Gears.FULL_NAME + " Particles...");
        PARTICLES.register(bus);
        System.out.println("Registering " + Gears.FULL_NAME + " Recipes Serializers...");
        RECIPE_SERIALIZERS.register(bus);
        System.out.println("Registering " + Gears.FULL_NAME + " Recipes...");
        RECIPES.register(bus);
        System.out.println("Registering " + Gears.FULL_NAME + " Menus...");
        MENUS.register(bus);
        System.out.println("Registering " + Gears.FULL_NAME + " Sounds...");
        SOUNDS.register(bus);
        System.out.println("Registering " + Gears.FULL_NAME + " Dimensions...");
        DIMENSIONS.register(bus);
        System.out.println("Registering " + Gears.FULL_NAME + " Done");
    }
}